"""
Example script for GMFlow optical flow inference
This demonstrates how to use GMFlow programmatically
"""
import torch
import numpy as np
...
def run_example():
    """
    Example of running GMFlow inference programmatically
    """
    # Initialize model
    ...
    # Save figure
    output_path = 'data/output/example_result.png'
    ...
    print("  python inference.py --img0 path/to/img0.jpg --img1 path/to/img1.jpg")
